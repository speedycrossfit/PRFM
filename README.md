...
**Status**
Pre-launch. Copy, CTA text, and the waitlist mechanic are placeholder pending final sign-off. Email forms are markup-ready but not wired to a backend yet
...
Push this repo to GitHub (including images/)
Connect it in Vercel
Vercel serves index.html from the root automatically 
Full deployment and editing notes are in HANDOFF.md. 

**Before this goes live** 
See Things Not Yet Built in HANDOFF.md — the email form backend and the launch-day CTA switch (LAUNCH_MODE in main.js) both need action before
